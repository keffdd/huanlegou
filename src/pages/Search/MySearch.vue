      ...
      <div class="py-container">
        ...
        <div class="bread">
          ...
          <ul class="fl sui-tag">
            ...
            <!-- 平台售卖属性的面包屑，不用v-if，用v-for因为他是一个数组 -->
            ...
            <ul class="yui3-g">
              <li class="yui3-u-1-5" v-for="good in goodsList" :key="good.id">
                <div class="list-wrap">
                  ...
                  <div class="commit">
                    <i class="command">已有<span>1999</span>人评价</i>
                  </div>
                  <div class="operate">
  ...
  export default {
    ...
    beforeMount() {
     ...
     methods: {
      ...
      // 删除分类的名字
      removecategoryName(){
        // 把相应的字段变为undefined，这个字段不会带给服务器
      this.searchParams.category1Id = undefined
      this.searchParams.category2Id =undefined
      this.searchParams.category3Id =undefined
      this.searchParams.categoryName = undefined
      this.getSearchData()
      // 把路径删除，如果路径存在params参数，也就是keywords就不要删除
